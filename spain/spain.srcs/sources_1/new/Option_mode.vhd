...
entity Option_mode is
	--??œ ë¡?ê²? in, out?„ ?” ì¶”ê??•˜?…”?„ ?©?‹ˆ?‹¤.(ex) for FFT configuration?„ ?œ„?•œ signal ?“±?“±..)
    Port ( 
...
END COMPONENT;
    ...
    signal sqrt_data : STD_LOGIC_VECTOR  (23 downto 0);
begin
...
-- Components
    ...
    port map (aclk => m_clk,
              ...
              s_axis_config_tvalid => fft_in_valid,
              ...
              m_axis_data_tlast    => open);
               fft_in_valid <= not m_reset;
               fft_in_data  <= x"00" & m_xin;
    ...
    SQRT : cordic_0
        ...
        m_yout (7) <= sqrt_data (18);
        m_yout (6 downto 0) <= sqrt_data (12 downto 6);
end Behavioral;