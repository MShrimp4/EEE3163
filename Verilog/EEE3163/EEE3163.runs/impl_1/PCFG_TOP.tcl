...
namespace eval ::optrace {
  variable script "/home/mshrimp/gitclones/EEE3163/Verilog/EEE3163/EEE3163.runs/impl_1/PCFG_TOP.tcl"
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force PCFG_TOP_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file PCFG_TOP_timing_summary_routed.rpt -pb PCFG_TOP_timing_summary_routed.pb -rpx PCFG_TOP_timing_summary_routed.rpx"
...
OPTRACE "Post-Route Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force PCFG_TOP_postroute_physopt.dcp
OPTRACE "Post-Route Phys Opt Design: write_checkpoint" END { }
OPTRACE "phys_opt_design reports" START { REPORT }
  create_report "impl_1_post_route_phys_opt_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -warn_on_violation -file PCFG_TOP_timing_summary_postroute_physopted.rpt -pb PCFG_TOP_timing_summary_postroute_physopted.pb -rpx PCFG_TOP_timing_summary_postroute_physopted.rpx"
  create_report "impl_1_post_route_phys_opt_report_bus_skew_0" "report_bus_skew -warn_on_violation -file PCFG_TOP_bus_skew_postroute_physopted.rpt -pb PCFG_TOP_bus_skew_postroute_physopted.pb -rpx PCFG_TOP_bus_skew_postroute_physopted.rpx"
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES XPM_MEMORY [current_project]
  catch { write_mem_info -force -no_partial_mmi PCFG_TOP.mmi }
