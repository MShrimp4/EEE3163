...
#
# Generated by Vivado on Wed May 11 12:50:25 KST 2022
...
# Script info
echo -e "RAM.sh - Script generated by export_simulation (Vivado v2021.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot RAM xil_defaultlib.RAM -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/opt/Xilinx/Vivado/2021.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
